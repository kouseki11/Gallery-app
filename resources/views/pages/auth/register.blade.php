            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 mx-auto mt-5">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.auth') }}" class="needs-validation"
                                novalidate="">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input id="name @error('name') is-invalid @enderror" type="name"
                                        class="form-control" name="name" tabindex="1" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="username @error('username') is-invalid @enderror" type="username"
                                        class="form-control" name="username" tabindex="1" required autofocus>
                                    <div class="invalid-feedback">
